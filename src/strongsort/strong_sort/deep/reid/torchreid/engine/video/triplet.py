...
from deep.reid.torchreid.engine.image import ImageTripletEngine
...
class VideoTripletEngine(ImageTripletEngine):
    ...
    Examples::
        ...
        datamanager = deep.reid.torchreid.data.VideoDataManager(
        ...
        engine = deep.reid.torchreid.engine.VideoTripletEngine(
